...
//initialize the gameon sdk
const defaultClient = new sdk.SkillsGameOnApiClient();
//create a generator, --creat a profile with no of task here and url 
...
function lookupPlayerProfile(externalPlayerId) {
    //getPlayerProfileFromId() helper function to give you all the player's information
 ...
 * @returns {Player}
 */
 //important, pass in score for the user
 ...
 * @returns {Player}
 */
 //if the competion expired, use this method
